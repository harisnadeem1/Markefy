...
const ResultsPage = () => {
    ...
    const handleNotImplemented = () => {
        toast({
            title: t('resultsPage.toast.notImplemented'),
        });
    };
    ...
    return (
        <>
            <Helmet>
                <title>{t('resultsPage.meta.title')}</title>
                <meta name="description" content={t('resultsPage.meta.description')} />
            </Helmet>
            <div className="pt-20 bg-white text-black">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-bold text-blue-600">
                        {t('resultsPage.hero.title')}
                    </h1>
                    <p className="text-lg md:text-xl text-gray-600 mt-4 max-w-3xl mx-auto">
                        {t('resultsPage.hero.description')}
                    </p>
                </motion.div>
                ...
                <div className="py-16 md:py-24 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
                        {caseStudiesIds.map((studyId, index) => {
                            const study = t(`caseStudyDetail.caseStudies.${studyId}`, { returnObjects: true });
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <Button 
                                            onClick={() => handleCaseStudyClick(studyId)} 
                                            variant="link" 
                                            className="text-blue-600 px-0 hover:text-blue-700"
                                        >
                                            {t('resultsPage.caseStudy.readButton')} 
